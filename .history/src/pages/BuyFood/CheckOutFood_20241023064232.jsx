...
const CheckOutFood = ({ selectedCinema, selectedCombos, onPayment, selectedAddress }) => {
    ...
    const Cinestar = {selectedAddress}
    

    const handlePayment = () => {
        console.log('Navigating to stepper with:', { totalPrice, selectedCombos, Cinestar }); // Kiểm tra dữ liệu gửi đi
        navigate("stepper", { state: { totalPrice, selectedCombos, Cinestar} });
    };
