...
const CheckOutFood = ({ selectedCinema, selectedCombos, onPayment }) => {
    ...
    const handlePayment = () => {
        console.log('Navigating to stepper with:', { totalPrice, selectedCombos, selectedCinema }); // Kiểm tra dữ liệu gửi đi
        navigate("stepper", { state: { totalPrice, selectedCombos, selectedCinema } });
    };
