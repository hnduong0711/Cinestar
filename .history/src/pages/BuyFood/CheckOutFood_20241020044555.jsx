                ...
                <div className="flex">
                    ...
                    {/* Div thứ hai chiếm 40% */}
                        <div className="flex-grow-[4] w-[40%] pr-15">
                            ...
                            <div>
                            <Button
                                        className="button md:button bg-cinestar-black w-[400px] h-[40px] text-white group items-center font-content border border-solid border-white"
                                        text="THANH TOÁN"
                                        colorChange="bg-oragan-yellow-dradient"
                                        onClick={() => navigate("/stepper")} // Điều hướng tới trang Stepper
                                    />
                            </div>
                        </div>
                    </div>
