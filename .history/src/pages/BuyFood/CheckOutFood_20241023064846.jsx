...
const CheckOutFood = ({ selectedCinema, selectedCombos, onPayment, selectedAddress }) => {
    ...
    const Cinestar = {selectedCinema}
    const CinestarAdress = {selectedAddress}
    console.log(selectedCinema)
    console.log(selectedAddress)

    const handlePayment = () => {
        console.log('Navigating to stepper with:', { totalPrice, selectedCombos, Cinestar, CinestarAdress }); // Kiểm tra dữ liệu gửi đi
        navigate("stepper", { state: { totalPrice, selectedCombos, Cinestar, CinestarAdress} });
    };
    ...
    return (
        <div className="flex flex-col">
            ...
            {selectedCombos.length > 0 && (
                <div className="bg-cinestar-black w-full h-[130px] p-4 fixed bottom-[0px] left-0">
                <hr className="w-full" />
