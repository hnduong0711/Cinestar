...
const ChoseCinema = ({ setSelectedCinema, setSelectedAdress }) => {
    ...
    useEffect(() => {
        const defaultCinema = choseLocationNears[0].title.toUpperCase(); // Giá trị mặc định là giá trị đầu tiên
        const defaultCinema1 = choseLocationNears[0].address.toUpperCase(); // Giá trị mặc định là giá trị đầu tiên
        setCinema(defaultCinema);
        setSelectedCinema(defaultCinema); // Cập nhật giá trị trong component cha
        setSelectedAdress(defaultCinema1); 
    }, [setSelectedCinema, setSelectedAdress]); // Chạy khi component được mount
