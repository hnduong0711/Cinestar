...
export default function HorizontalLinearAlternativeLabelStepper() {
  ...
  const { totalPrice, selectedCombos, choseLocationNears } = location.state || {}; // Thêm cinemaLocation
...
<div style={{ flex: '3', marginRight: '2rem', maxWidth: '60%' }}>
  <Box sx={{ width: '100%', padding: '2rem' }}>
    ...
    <div style={{ flex: '2', maxWidth: '40%' }}>
      ...
      <div>
      <div>Cinestar</div>
      <div>Địa chỉ: {choseLocationNears ? choseLocationNears.title : 'Chưa có tên rạp'}</div> {/* Hiển thị tên rạp */}
        <div>Địa chỉ</div>
      </div>
      <div>
        <div>Bắp nước</div>
