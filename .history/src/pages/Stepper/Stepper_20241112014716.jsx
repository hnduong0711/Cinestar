      ...
      {activeStep === steps.length ? (
        ...
        <div>
          ...
          {activeStep === 1 && (
           ...
           <div class="p-4 bg-[#305fbf] rounded-lg flex items-center space-x-3 hover:bg-oragan-yellow-dradient transition-colors duration-300 ease-in-out hover:shadow-md hover:transform hover:-translate-x-1">     
