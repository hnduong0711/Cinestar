...
export default function HorizontalLinearAlternativeLabelStepper() {
  ...
  const { totalPrice, selectedCombos, cinemaLocation } = location.state || {}; // Thêm cinemaLocation
...
<div style={{ flex: '3', marginRight: '2rem', maxWidth: '60%' }}>
  <Box sx={{ width: '100%', padding: '2rem' }}>
    ...
    <div>
      <div className='text-white font-medium'>Tên rạp: {selectedCinema.title}</div>
      <div className='text-white font-medium'>Địa chỉ: {selectedCinema.address}</div>
    </div>
    <div>
      <h2 className='text-white font-medium'>Thông tin combo đã chọn:</h2>
    ...
    <div>
      <h2 className='text-white font-medium'>Tổng tiền thanh toán:</h2>
      <div className='text-white'>{totalPrice ? `${totalPrice} VND` : 'Chưa có giá'}</div>
    </div>
  </div>
