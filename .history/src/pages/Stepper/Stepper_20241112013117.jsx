      ...
      {activeStep === steps.length ? (
        ...
        <div>
          ...
          {activeStep === 1 && (
           ...
           <div className="flex items-center p-4 bg-[#1f294b] rounded-lg border border-gray-500 cursor-pointer hover:bg-white hover:text-black">
              ...
              <div className="flex items-center p-4 bg-gray-600 rounded-lg border border-gray-500 cursor-pointer hover:bg-white hover:text-black">
