             ...
             {selectedCombos && selectedCombos.length > 0 ? (
               selectedCombos.map((combo, index) => (
                 <div key={index} className="flex flex-col mb-4 p-4">
                   ...
                   <div className="text-cinestar-custom-yellow text-left mb-[20px] text-[20px]">{combo.content}</div>
                   <hr />
                   <div className="text-cinestar-custom-yellow font-bold text-left mt-[30px] text-[30px]">{combo.price} VND</div>
                 </div>
               ))
             ) : (
