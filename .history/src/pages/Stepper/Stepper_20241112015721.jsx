                ...
                {selectedCombos && selectedCombos.length > 0 ? (
                  selectedCombos.map((combo, index) => (
                    <li key={index} className="flex items-center justify-between mb-4">
                      <span className="text-lg font-medium">{combo.title}</span>
                      <span className="text-gray-500">{combo.content}</span>
                      <span className="text-red-500 font-bold">{combo.price} VND</span>
                    </li>
                  ))
                ) : (
