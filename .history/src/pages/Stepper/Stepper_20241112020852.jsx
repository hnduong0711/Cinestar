             ...
             {selectedCombos && selectedCombos.length > 0 ? (
               selectedCombos.map((combo, index) => (
                 <div key={index} className="flex flex-col mb-4 p-4">
                    <div className="text-white font-content text-left text-[30px] mb-[30px]">{combo.title}</div>
                   <div className="text-cinestar-custom-yellow text-left mb-[30px]">{combo.content}</div>
                   <hr />
                   <div className="text-cinestar-custom-yellow font-bold text-left mt-[30px]">{combo.price} VND</div>
                 </div>
               ))
             ) : (
