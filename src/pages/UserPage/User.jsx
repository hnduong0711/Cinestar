...
const UserPage = () => {
    ...
    return (
        <div class=" min-h-screen p-8">
            ...
            <div class="container flex mt-32 mx-auto">
                <div class="w-1/5 p-4 py-8 bg-purple-blue-gradient text-white rounded-lg h-fit">
                    <div class="flex items-center space-x-4">
                        <img src={UserIcon} alt="user" width={48} height={48} />
                        <div>
                            <h2 class="text-lg font-semibold">Ten dang nhap</h2>
                            <button class="text-xs underline">Thay đổi ảnh đại diện</button>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="font-bold bg-yellow-300 text-black text-center py-2">
                            <p>C'Friends</p>
                        </div>
                        <p class="my-2">Tích điểm C'Friends</p>
                        <div class="w-full h-2 bg-gray-300 rounded-full my-2">
                            <div class="bg-yellow-400 h-2 rounded-full w-[50%]"></div>
                        </div>
                        <p class="text-sm">0/10K</p>
                    </div>
                    <ul class="mt-6 space-y-2">
                        <a  class="flex m-3" onClick={setTabInfo}>
                            <img class="mr-3" src={UserIcon} alt="user" width={16} height={16} />
                ...
                <div  className={`${tab ? "block w-3/4 pl-8" : "hidden"}`}>
                    ...
                    <h1 class="text-2xl font-bold text-white">THÔNG TIN KHÁCH HÀNG</h1>
                    ...
                    <div class="bg-white rounded-lg p-6 mt-6 shadow-md">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="text" class="w-full mt-1 p-2 border rounded" value=""></input>
                            </div>
                            <div>
                                <label class="block text-gray-700">Ngày sinh</label>
                                <input type="date" class="w-full mt-1 p-2 border rounded" value=""></input>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="email" class="w-full mt-1 p-2 border-2 rounded" value=""></input>
                            </div>
                        </div>
                        <button class="mt-4 bg-gray-200  py-2 px-4 rounded font-bold">LƯU THÔNG TIN</button>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-6 mt-6 shadow-md">
                        ...
                        <div class="grid gap-4 mt-4">
                            <div>
                                ...
                                <input type="password" class="w-full mt-1 p-2 border rounded"></input>
                            </div>
                            <div>
                            ...
                            <div>
                                <label class="block text-gray-700">Xác thực mật khẩu *</label>
                                <input type="password" class="w-full mt-1 p-2 border rounded"></input>
                            </div>
                        </div>
                        <button class="mt-4 bg-gray-200  py-2 px-4 rounded font-bold">ĐỔI MẬT KHẨU</button>
                    </div>
                </div>

                {/* CONTENT LICH SU */}
                <div className={`${tab ? "hidden" : "block w-3/4 pl-8"}`}>
                    <h1 class="text-2xl  text-white font-bold mb-6">LỊCH SỬ MUA HÀNG</h1>
